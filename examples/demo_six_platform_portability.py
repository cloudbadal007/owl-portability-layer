...
def main() -> None:
    ...
    print("=== Test 1: Valid PaymentEvent across six platforms ===")
    valid_payload = {"paymentId": "PAY-6P-100", "amountUSD": 25000}
    ...
    print("\n=== Test 2: ComplianceHold without approver blocked on all six ===")
    blocked_payload = {
        "paymentId": "PAY-6P-HOLD",
        "amountUSD": 150000,
    ...
    print(
        "\nSix platforms. One OWL/SHACL constraint layer.\n"
        "The SHACL constraint is identical across all six.\n"
