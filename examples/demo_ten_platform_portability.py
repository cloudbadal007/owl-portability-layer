"""Ten-platform portability demo with identical SHACL governance.
...
def main() -> None:
    ...
    print("=== Test 1: Valid PaymentEvent across ten platforms ===")
    valid_payload = {"paymentId": "PAY-10P-100", "amountUSD": 25000}
    ...
    print("\n=== Test 2: ComplianceHold without approver blocked on all ten ===")
    blocked_payload = {
        "paymentId": "PAY-10P-HOLD",
        "amountUSD": 150000,
    ...
    print(
        "\nTen platforms. One OWL/SHACL constraint layer.\n"
        "The SHACL constraint is identical across all ten.\n"
        "Change target_platform. Change the reasoning model.\n"
        "The governance never changes.\n"
        "\nPlatforms: Grok-on-Databricks | OpenAI Frontier | IBM watsonx\n"
        "           Dataverse | AgentCore | ServiceNow | Google\n"
        "           Fabric IQ | Palantir | Salesforce"
    )
