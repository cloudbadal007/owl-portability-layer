"""Seven-platform portability demo with identical SHACL governance.
...
def main() -> None:
    ...
    print("=== Test 1: Valid PaymentEvent across seven platforms ===")
    valid_payload = {"paymentId": "PAY-7P-100", "amountUSD": 25000}
    ...
    print("\n=== Test 2: ComplianceHold without approver blocked on all seven ===")
    blocked_payload = {
        "paymentId": "PAY-7P-HOLD",
        "amountUSD": 150000,
    ...
    print(
        "\nSeven platforms. One OWL/SHACL constraint layer.\n"
        "The SHACL constraint is identical across all seven.\n"
        "Change target_platform. The governance never changes.\n"
        "\nPlatforms: IBM watsonx | Dataverse | AgentCore | ServiceNow\n"
        "           Google | Fabric IQ | Palantir"
    )
